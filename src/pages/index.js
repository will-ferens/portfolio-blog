    ...
    {matches =>
        matches ? (
          ...
          <div style={{
            ...
            <li>
              <Link to="/tech" style={{textDecoration: `none`}}><h1>Tech</h1></Link>
            </li>
            <li>
              <TitleList
                posts={posts}
            ...
            <li>
            <Link to="/culture" style={{textDecoration: `none`}}><h1>Culture</h1></Link>
            </li>
            <li>
              <TitleList
                posts={posts}
            ...
            <li>
            <Link to="/nature" style={{textDecoration: `none`}}><h1>Nature</h1></Link>
            </li>
            <li>
              <TitleList
                posts={posts}
