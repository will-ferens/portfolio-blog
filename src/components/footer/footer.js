...
const Footer = () => (
  <Styled.Footer>
    <Styled.FooterItem>
      <h1>
        Looking for a dev? <span>Reach out.</span>
      </h1>
      <p>
        Whether you're looking for your next hire, have a question, or just want
        to connect - drop a line.
      </p>
      ...
      <Styled.Social>
        <li className="nav-item">
          <a
            href="https://twitter.com/will_ferens"
            target="_blank"
